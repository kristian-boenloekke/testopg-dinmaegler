...
export async function GET(request) {
    ...
    return new ImageResponse(
        (
            <div tw='w-full h-full flex flex-col items-center justify-center p-32 rounded-full'>


                    <svg tw='w-full h-full' width="54" height="49" viewBox="0 0 54 49" fill="none" xmlns="http://www.w3.org/2000/svg">
